...
0000000000400526 <main>:
  ...
  40052e:	c7 45 f4 0c 00 00 00 	mov    DWORD PTR [rbp-0xc],0xc
  400535:	48 c7 45 f8 e4 05 40 	mov    QWORD PTR [rbp-0x8],0x4005e4
  40053c:	00 
  40053d:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
  400541:	ba 0c 00 00 00       	mov    edx,0xc
  400546:	48 89 c6             	mov    rsi,rax
  400549:	bf f1 05 40 00       	mov    edi,0x4005f1
  40054e:	b8 00 00 00 00       	mov    eax,0x0
  400553:	e8 a8 fe ff ff       	call   400400 <printf@plt>
